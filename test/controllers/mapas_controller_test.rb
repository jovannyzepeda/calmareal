...
class MapasControllerTest < ActionController::TestCase
  ...
  test "should create mapa" do
    assert_difference('Mapa.count') do
      post :create, mapa: { alt: @mapa.alt, descripcion: @mapa.descripcion, lon: @mapa.lon, titulo: @mapa.titulo }
    end
  ...
  test "should update mapa" do
    patch :update, id: @mapa, mapa: { alt: @mapa.alt, descripcion: @mapa.descripcion, lon: @mapa.lon, titulo: @mapa.titulo }
    assert_redirected_to mapa_path(assigns(:mapa))
  end
